...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    filterClothes = iteamclothe
        .where((Product product) => product.category == currentCategory.id)
        .toList();
  }
...
class _ItemDetailState extends State<ItemDetail>
  ...
  void initState() {
    ...
    animation = CurvedAnimation(
      curve: Interval(widget.index < 10 ? widget.index / 10 : 0.0, 1.0,
  ...
  Widget build(BuildContext context) {
    ...
    return Transform(
      transform:
          Matrix4.translationValues(size.width * animation.value, 0.0, 0.0),
      child: Padding(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Center(
                      ...
                      style: TextStyle(
                          color: Colors.white, fontFamily: "Comicneue"),
                    )),
                  ),
                ],
              )),
